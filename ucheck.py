...
#Didn't want to implement input functions cause waste of time just change your credentials once and save the file and then just run the .py file everytime or use command prompt and not have your username and pass lying open in your computer.
